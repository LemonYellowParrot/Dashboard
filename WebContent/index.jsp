  ...
  <body>
    ...
    <section class="container">
    	<form method="get" action="./index.jsp" class="form-inline mt-3">
    		<select name="LectureDivide" class="form-control mt-1 mt-2">
    ...
    <div class="card bg-light mt-3">
    	<div class="card-header bg-light">
    		...
    		<div class="card-body">
    			<h5 class="card-title">
    				정말 좋은 강의예요.&nbsp;<small>(2020년 1학기)</small>
    			</h5>
    			<p class="card-text">강의가 많이 널널해서, 솔직히 많이 배운 건 없지만 학점도 잘 나왔습니다.</p>
    			<div class="row">
    	...
    	<div class="modal-dialog">
    		<div class="modal-content">
    			...
    			<div class="modal-body">
    				<form action="./evoloationRegisterAction.jsp" method="post">
    					<div class="form-row">
    					...
    					<div class="form-group">
              			...
              			<div class="form-row">
              				...
              				<div class="form-group col-sm-3">
              					<label>성적</label>
              					<select name="creditlScore" class="form-control">
              						<option value="A" selected>A</option>
              						<option value="B">B</option>
              						<option value="C">C</option>
              						<option value="D">D</option>
    ...
    Copyright ⓒ 2020 이주연 All Rights Reserved.
    </footer>
